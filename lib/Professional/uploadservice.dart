...
final seviceref = Firestore.instance.collection('services');
final postsRef = Firestore.instance.collection('Prousers');
...
class _UploadState extends State<Upload>
  ...
  createPostInFirestore(
      ...
      String price,
      String category}) {
    seviceref.document(postId).setData({
      "postId": postId,
      ...
      body: ListView(
        children: <Widget>[
            ...
            title: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: "Write a category of your service......",
          ...
          ListTile(
            title: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: "Write a description of your service......",
                  border: InputBorder.none,
                ),
              ),
            ),
          ...
          ListTile(
            title: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText: "Write a Price of your service......",
                  border: InputBorder.none,
                ),
              ),
            ),
          ...
          loctoggle
              ...
              : Center(child: Text("Loading Location")),
          Divider(),
          SizedBox(height: 10),
          GestureDetector(
            onTap: () {
