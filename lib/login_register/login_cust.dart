...
import 'package:Eserve/login_register/register_cust.dart';
...
class LoginCust extends StatefulWidget {
  @override
  _LoginCustState createState() => _LoginCustState();
}

class _LoginCustState extends State<LoginCust> {
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) => RegCust()));
                      },
                      child: Text("Sign UP!",
                          style: TextStyle(
                              fontSize: 18.0,
  ...
  Future<void> _showMyDialog(
      String ussid, String pu, String dispn, String em, String ll) async {
